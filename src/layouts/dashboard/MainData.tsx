    ...
    return (
        <div className='grid grid-cols-3 px-4'>
            <div className='flex flex-col sm:flex-row items-center'>
                <GreenSvg />
                <div>
                    <p className='text-card-foreground font-semibold sm:text-xl'>Medicine #580</p>
            ...
            <div className='flex flex-col sm:flex-row items-center'>
                <OrangeSvg />
                <div>
                    <p className='text-card-foreground font-semibold sm:text-xl'>3 vaccines</p>
            ...
            <div className='flex flex-col sm:flex-row items-center'>
                <RedSvg />
                <div>
                    <p className='text-card-foreground font-semibold sm:text-xl'>15 products</p>
